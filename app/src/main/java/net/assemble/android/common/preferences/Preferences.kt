...
abstract class Preferences(context: Context) {
    private val prefs = context.getSharedPreferences(javaClass.simpleName, Context.MODE_PRIVATE)
    ...
    inner class StringPrefDelegate(prefKey: String?, private val defaultValue: String?)
    ...
    inner class IntPrefDelegate(prefKey: String?, private val defaultValue: Int)
    ...
    inner class FloatPrefDelegate(prefKey: String?, private val defaultValue: Float)
    ...
    inner class BooleanPrefDelegate(prefKey: String?, private val defaultValue: Boolean)
    ...
    inner class LongPrefDelegate(prefKey: String?, private val defaultValue: Long)
    ...
    fun stringSetPref(prefKey: String? = null, defaultValue: Set<String> = setOf()) =
            StringSetPrefDelegate(prefKey, defaultValue)

    inner class StringSetPrefDelegate(prefKey: String?, private val defaultValue: Set<String>)
